  ...
  { icon:'📖', name:'Language & Literature', sub:'English, Text Analysis, Media',
    topics:[
      ...
      { label:'Narrative voice & reader interpretation', concept:'Perspective', related:'Representation, Communication, Identity', lp:'Thinkers, Open-minded, Communicators', atl:'Thinking, Communication',
        scene:'An animated storybook that changes character perspective. Same story events retold from different vantage points.',
        ...
        explain:'Students discover how the same events feel radically different depending on narrative voice and withheld information.',
  ...
  { icon:'🗣️', name:'Language Acquisition', sub:'Hindi, French, Spanish',
    topics:[
      ...
      { label:'Register & formality — social rules of language', concept:'Communication', related:'Perspective, Identity, Context', lp:'Communicators, Principled, Open-minded', atl:'Communication, Social skills',
        scene:'A series of animated social situations — job interview, family dinner, text message exchange, formal letter.',
        ...
        explain:'Students discover that being linguistically "correct" is insufficient — register, cultural context, and formality are equally important.',
  ...
  { icon:'📊', name:'Business Management', sub:'SL & HL',
    topics:[
      ...
      { label:'International expansion — market entry strategies', concept:'Growth', related:'Globalisation, Risk, Culture', lp:'Thinkers, Open-minded, Knowledgeable', atl:'Thinking, Research',
        scene:'A world map where a home company expands arrows into new countries. Entry mode icons appear. Cultural distance meter glows.',
        ...
        explain:"Students discover why McDonald's India removed beef, why Walmart failed in Germany, and why Starbucks succeeded in China.",
  ...
  { icon:'🧮', name:'Mathematics AA', sub:'SL & HL — Analysis & Approaches',
    topics:[
      ...
      { label:'Differential equations — Lotka-Volterra predator-prey', concept:'Change', related:'Function, Patterns, Modelling', lp:'Inquirers, Thinkers', atl:'Thinking, Research',
        scene:'Rabbits and foxes in a meadow — the Lotka-Volterra model visualised. Rabbit and fox populations oscillate as animated numbers.',
        ...
        explain:"Students model the Lotka-Volterra predator-prey system, seeing how parameters control oscillation, stability, and extinction risk.",
  ...
  { icon:'📉', name:'Mathematics AI', sub:'SL & HL — Applications & Interpretation',
    topics:[
      ...
      { label:'Network theory & optimisation — shortest paths', concept:'Systems', related:'Patterns, Logic, Models', lp:'Thinkers, Knowledgeable', atl:'Thinking, Research',
        scene:'An animated city map with nodes (delivery stops) and edges (roads). A delivery vehicle moves along routes.',
        ...
        explain:"Students navigate Dijkstra's algorithm and critical path analysis.",
  ...
  { icon:'💻', name:'Computer Science', sub:'SL & HL',
    topics:[
      ...
      { label:'Cybersecurity & encryption — keeping data safe', concept:'Privacy and security', related:'Systems, Ethics, Communication', lp:'Principled, Thinkers', atl:'Thinking, Research',
        scene:'A network diagram with client, server, and interceptor nodes. Data packets travel as animated blobs. Encryption lock icons appear when protocols activate.',
        ...
        explain:"Students discover security is always a trade-off with usability.",
  ...
  { icon:'⚗️', name:'Chemistry', sub:'SL & HL',
    topics:[
      ...
      { label:'Electrochemistry & galvanic cell optimisation', concept:'Reactivity', related:'Energetics, Redox, Electrochemistry', lp:'Knowledgeable, Thinkers', atl:'Thinking, Research',
        scene:'Laboratory bench with two beaker half-cells connected by a salt bridge. Electrode surfaces show deposits forming or dissolving. Voltmeter display updates in real time.',
        ...
        explain:'Students optimise a Zn/Cu galvanic cell, applying Nernst equation principles.',
  ...
  { icon:'🧬', name:'Biology', sub:'SL & HL',
    topics:[
      ...
      { label:'Thermoregulation & homeostasis under stress', concept:'Homeostasis', related:'Feedback, Regulation, Systems', lp:'Knowledgeable, Thinkers', atl:'Thinking, Self-management',
        scene:'A human body silhouette with core temperature shown as a heat map. Sweat drops appear in heat. Shivering animation in cold.',
        ...
        explain:'Students maintain core temperature within the survivable range across 5 environmental challenges.',
  ...
  { icon:'🌱', name:'Environmental Systems', sub:'ESS',
    topics:[
      { label:'Carbon cycle & climate feedback', concept:'Systems and models', related:'Flows, Feedback, Climate', lp:'Caring, Thinkers', atl:'Thinking, Research',
        ...
        explain:'Students manage the carbon cycle, experiencing how feedback loops accelerate warming non-linearly.',
      ...
      { label:'Biodiversity & ecosystem services', concept:'Biodiversity', related:'Systems, Value, Sustainability', lp:'Caring, Principled', atl:'Research, Thinking',
        scene:'Tropical rainforest canopy viewed from above. Species diversity shown as coloured spots. Pollinator routes animate between flowers.',
        ...
        explain:'Students discover biodiversity loss is not just ethical — ecosystem services have direct economic value.',
  ...
  { icon:'🌐', name:'Global Politics', sub:'Power, Rights, Development',
    topics:[
      ...
      { label:'Nuclear deterrence & global security dilemmas', concept:'Peace and conflict', related:'Power, Security, Sovereignty', lp:'Principled, Thinkers, Balanced', atl:'Thinking, Research',
        scene:'Cold-war style global map with nuclear-capable state icons. Tension meter in center shows escalation risk. Diplomatic channel lines glow when active.',
        ...
        explain:'Students experience the security dilemma firsthand — building up weapons for security triggers the adversary to do the same.',
  ...
  { icon:'📝', name:'English A', sub:'Lang & Lit / Literature SL & HL',
    topics:[
      { label:"Author's choices — constructing meaning", concept:'Perspective', related:'Representation, Communication', lp:'Thinkers, Open-minded', atl:'Thinking, Communication',
        ...
        explain:"Students make author choices observing how they shift reader experience.",
      ...
      { label:'Language & power — who controls the narrative?', concept:'Power', related:'Identity, Representation, Communication', lp:'Principled, Open-minded, Thinkers', atl:'Thinking, Communication, Research',
        scene:'A city square where different groups hold signs with different words for the same concept. A dominant narrative spotlight shines on some voices, leaving others in shadow.',
        ...
        explain:"Students discover how language itself is a site of power — who gets to name things, which words are chosen, whose stories are amplified.",
      ...
      { label:'Intertextuality — how texts speak to each other', concept:'Transformation', related:'Perspective, Culture, Communication', lp:'Knowledgeable, Thinkers, Open-minded', atl:'Research, Thinking, Communication',
        scene:'A literary web — books float as connected nodes. Quotation arrows glow between texts. Allusion threads connect across time periods.',
        ...
        explain:"Students experience how intertextual connections work by adjusting degree and nature of borrowing.",
  ...
  { icon:'🙏', name:'Hindi A/B', sub:'Language Acquisition & Literature',
    topics:[
      { label:'Hindi acquisition — immersion, input & identity', concept:'Communication', related:'Context, Identity, Culture', lp:'Communicators, Open-minded, Risk-takers', atl:'Communication, Self-management',
        scene:'An animated Hindi-language town (शहर) where a learner walks through markets, schools, and homes. Devanagari script appears on signs.',
        ...
        explain:"Students experience how Hindi acquisition works through the relationship between input and output.",
      ...
      { label:'Hindi साहित्य — text, context & society', concept:'Perspective', related:'Identity, Culture, Representation', lp:'Open-minded, Knowledgeable, Thinkers', atl:'Thinking, Communication, Research',
        scene:'An animated literary timeline of Hindi literature — from Kabir and Mirabai through Premchand to modern digital poetry.',
        ...
        explain:"Students explore how Hindi literary texts reflect and challenge social conditions of their time.",
...
/* ═══════════════ TEACHER ASSESSMENT ═══════════════ */
function setAssess(answer) {
  const yesChip = document.getElementById('chip-assess-yes');
  const noChip  = document.getElementById('chip-assess-no');
  const wrap    = document.getElementById('assess-code-wrap');

  // Remove active state from both
  yesChip.classList.remove('on');
  noChip.classList.remove('on');

  if (answer === 'yes') {
    yesChip.classList.add('on');
    setChipOn(yesChip);
    // Reset no chip to neutral
    noChip.classList.remove('border-myp','bg-myp-light','text-myp-dark','border-dp','bg-dp-light','text-dp-dark');
    noChip.classList.add('border-surface-200','bg-white','text-ink-muted');
    wrap.style.display = 'block';
  } else {
    noChip.classList.add('on');
    setChipOn(noChip);
    // Reset yes chip to neutral
    yesChip.classList.remove('border-myp','bg-myp-light','text-myp-dark','border-dp','bg-dp-light','text-dp-dark');
    yesChip.classList.add('border-surface-200','bg-white','text-ink-muted');
    wrap.style.display = 'none';
    // Clear the textarea when hidden
    document.getElementById('f-assess-code').value = '';
  }
}
...
function buildPrompt() {
  ...
  // ── Assessment criteria (new feature) ──
  const assessYes = document.getElementById('chip-assess-yes').classList.contains('on');
  const assessCode = assessYes ? (document.getElementById('f-assess-code').value.trim()) : '';
  const assessStr = (assessYes && assessCode)
    ? '\n\n// ──────────────────────────────────────────────────────────\n// ASSESSMENT CRITERIA — EMBED IN SIMULATION\n// ──────────────────────────────────────────────────────────\n\nThis simulation is being used as a FORMAL ASSESSMENT TASK.\nEmbed the following assessment criteria visibly in the simulation:\n\n' + assessCode + '\n\nInstructions for Claude:\n• Display the assessment criteria on the splash screen before the simulation begins.\n• Show a small "Assessment criteria" reference button (floating, always visible) that students can tap to review the criteria at any point.\n• After the final round, display a self-assessment panel where students rate their own performance against each criterion before submitting.'
    : '';
...
• Works offline except Google Fonts${ctxStr}${assessStr}
...
Reply with letter(s) or 'none' to use as-is."`;
  ...
  document.getElementById('out-body').textContent = prompt;
  document.getElementById('out-subtitle').textContent = `${prog} · ${subj.name} · ${t.label}`;
...
async function enhanceWithAI() {
  ...
  const progCtx = document.getElementById('enh-prog') ? document.getElementById('enh-prog').value : '';
  const gradeCtx = document.getElementById('enh-grade') ? document.getElementById('enh-grade').value : '';
  const toneCtx = document.getElementById('enh-tone') ? document.getElementById('enh-tone').value : 'Professional';

  let metaPrompt = `You are an expert IB educational prompt engineer. Your task is to rewrite the user's teaching prompt using the frameworks below.\n\nCRITICAL INSTRUCTION: Output ONLY the rewritten prompt itself. Do not include any explanation, preamble, commentary, intro sentence, or closing note.\n\nFrameworks to apply:\n`;
...
function saveToHistory(source) {
  let prompt = '', label = '';
  if (source === 'sim') {
    prompt = document.getElementById('out-body') ? document.getElementById('out-body').textContent : '';
    label = document.getElementById('out-subtitle') ? document.getElementById('out-subtitle').textContent : 'Simulation';
  } else {
    prompt = document.getElementById('enhance-out-body') ? document.getElementById('enhance-out-body').textContent : '';
...
function loadFromHistory(id) {
  ...
  if (!h) return;
  if (h.source === 'sim') {
    document.getElementById('out-body').textContent = h.prompt;
    document.getElementById('out-subtitle').textContent = h.label;
    show('out-section');
  } else {
    const ebody = document.getElementById('enhance-out-body');
    if (ebody) { ebody.textContent = h.prompt; }
    const eout = document.getElementById('enhance-output');
    if (eout) { eout.classList.remove('hidden'); }
  }
...
function copyGuidePrompt(btn) {
  const blk = btn.parentElement.querySelector('.prompt-blk');
  if (!blk) return;
  navigator.clipboard.writeText(blk.innerText).then(() => toast('Copied!')).catch(() => toast('Failed','error'));
}
...
function openInClaude() {
  const p = document.getElementById('out-body').textContent;
  if (!p) return;
...
function openInChatGPT() {
  const p = document.getElementById('out-body').textContent;
  if (!p) return;
  window.open('https://chat.openai.com/?prompt=' + encodeURIComponent(p), '_blank');
}

function openInGemini() {
  const el = document.getElementById('out-body');
  if (!el) return;
  const p = el.textContent.trim();
  if (!p) return;
  navigator.clipboard.writeText(p).catch(() => {});
  window.open('https://gemini.google.com/guided-learning?query=' + encodeURIComponent(p.slice(0, 2000)), '_blank');
}
...
function resetAll() {
  state.subj = null; state.topic = null;
  hide('topic-section'); hide('custom-section'); hide('out-section');
...
function sendMod(text) {
  window.open('https://claude.ai/new?q=' + encodeURIComponent(text), '_blank');
}

function openCustomMod() {
  document.getElementById('custom-mod-area').style.display = 'block';
}

function sendCustomMod() {
  const txt = document.getElementById('custom-mod-txt').value.trim();
  if (!txt) { toast('Please enter a modification request.', 'warn'); return; }
  sendMod(txt);
}
